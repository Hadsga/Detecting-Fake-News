...
Let´s check how the authors are distributed over different classes. "Pam Key" is very common on reliable articles whereby "nan" is common on the unreliable ones.
...
I evaluate the results by calculating the confusion matrix. Overall, there is an accuracy of 99%. However, the learner is slightly better detecting unreliable news articles then reliable ones. 
